  ...
  try {
    ...
    var buttons = window.paypal.Buttons({
      ...
      onClick: function(data, actions) {
        // Always allow PayPal to open — validate shipping in onApprove
      ...
      onApprove: async function(data, actions) {
        if (!shippingValid()) {
          ...
          container.innerHTML = '<p style="color:#E01535;font-size:.72rem;text-align:center;font-family:var(--font-c);padding:12px 0">Please complete your shipping info and try again.</p>';
          return;
        }
